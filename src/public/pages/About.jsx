  ...
  return (
    <div>
      <div className="h-screen flex flex-col items-center justify-center bg-gradient-to-r from-[#ED008D] to-[#00CFFF] relative text-white font-Poppins px-4">
        ...
        <div className="text-center absolute top-28 z-10 flex px-4 flex-col items-center gap-8">
          <h1 className="text-3xl">About Us</h1>

          <h3 className="">
            we believe in the power of print to bring ideas to life. Established
            in [Year], our mission<br></br> has been to provide high-quality,
            reliable, and innovative printing solutions that cater to<br></br>{" "}
            the diverse needs of our clients. From business essentials to
            personalized creations,<br></br> we're here to make your vision
            tangible.
          </h3>
        </div>
      </div>
